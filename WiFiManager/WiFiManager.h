...
//const char HTTP_FORM_TIME_START[] PROGMEM    =
//const char HTTP_FORM_TIME_END[] PROGMEM      =
...
/////////---------------------------------------------------
  ...
  private:
	...
	/////////---------------------------------------------------
	void 		doAction(int r, int g, int b);
	uint8_t 	led_r = 0;
	uint8_t 	led_g = 0;
	uint8_t 	led_b = 0;
	/////////---------------------------------------------------
